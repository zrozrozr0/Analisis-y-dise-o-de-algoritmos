...
/*Alumno: Noé Rodríguez Olmos
  Algoritmo de Karatsuba para multiplicación de enteros largos
...
int main(void)
{
	...
	printf("Introduce el primer entero a multiplicar:\t");
	scanf("%s", a);
	printf("Introduce el segundo entero a multiplicar:\t");
	scanf("%s", b);
	long k=strlen(a);
	long o=strlen(b);
